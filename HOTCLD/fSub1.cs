...
namespace HOTCLD
{
    public partial class fSub1 : Form
    {
        ...
        private int mnTargetcol, mnTargetrow;
        private List<String> _entry = new List<String> { "2legs[OR]4legs", "horns??", "whiskers?", "prey?", "likea_statue?", "giveover_Weapons?" };
        private List<bool> _useentry = new List<bool> { false, false, false, false, false, false };
        private bool mbShortest;
        private int mnWin = 0;
        ...
        private int fDistance()
        {
            ...
            if (mnRow <= mnTargetrow)
            {
                yDistance = mnTargetrow - mnRow+1;
            }
            else
            {
                yDistance =  mnRow-mnTargetrow+1;
            }
            if (mnCol <= mnTargetcol)
            {
                xDistance = mnTargetcol - mnCol + 1;
            }
            else
            {
                xDistance = mnCol - mnTargetcol + 1;
            }
        ...
        private void fReset()
        {
            ...
            mnRotate = 1;
            mbShortest = true;
            btnShortest.Text = "mbShortest = ON";
        ...
        private void fPeek(int nValue, int nRotate, ref PictureBox _pic2)
        {
            ...
            {
                Name = "pictureBox2",
                Image = Image.FromFile(@"F rock.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
        ...
        private void btnShortest_Click(object sender, EventArgs e)
        {
            ...
            {
                mbShortest = false;
                btnShortest.Text = "mbShortest = OFF";
            }
            else
            {
                mbShortest = true;
